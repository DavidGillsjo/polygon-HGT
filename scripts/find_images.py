...
def save_images(annotations, img_dir, output_dir, image_plotter, nbr_images = None, filenames = [], filename_folder=None, show_legend = False):
    ...
    if filename_folder:
        ...
        annotations = annotations[:nbr_images]
    ...
    for ann in tqdm(annotations):
        ...
        image_plotter.plot_gt_image(image, ann, ann_dir, desc='GT_NOHATCH', show_legend = show_legend, ext='.pdf', skip_hatch=True)
...
if __name__ == "__main__":
    ...
    image_plotter = ImagePlotter(lm.get_line_labels(), lm.get_junction_labels(), cfg.MODEL.PLANE_LABELS)

...
from parsing.dataset import move_datasets
...
if __name__ == "__main__":
    ...
    logger = setup_logger('srw-eval', output_dir, out_file='eval.log')
    ...
    for jfile in tqdm(json_files):
        ...
        pAP_dict = tester.eval_pap(res, annotations_dict, epoch)
        room_dict = tester.eval_room_layout(res, annotations_dict, epoch)

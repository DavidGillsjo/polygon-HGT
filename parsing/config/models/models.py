...
MODELS.GNN   = GNN
MODELS.PLANE_HEAD   = PLANE_HEAD
MODELS.SCALE = 1.0

MODELS.JUNCTION_LABELS = ['invalid', 'valid']
MODELS.LINE_LABELS = ['invalid', 'valid']
MODELS.PLANE_LABELS = ['invalid', 'valid']

MODELS.ENABLE_TIMING = True

# ONly for GT line model
MODELS.NEGATIVE_LINE_RATIO = 0.0

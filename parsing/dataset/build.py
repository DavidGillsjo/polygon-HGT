...
def build_train_dataset(cfg):
    ...
    dargs = DatasetCatalog.get(name, cfg.DATASETS.TMP_DIR)
    ...
    args['transform'] = Compose(
                                [Resize(cfg.DATASETS.IMAGE.HEIGHT,
                                 ...
                                 Normalize(cfg.DATASETS.IMAGE.PIXEL_MEAN,
                                           cfg.DATASETS.IMAGE.PIXEL_STD,
                                           cfg.DATASETS.IMAGE.TO_255),
                                 NormalizePlaneParameters(cfg.DATASETS.PLANE_PARAMETERS.MEAN,
                                                          cfg.DATASETS.PLANE_PARAMETERS.STD)
                                 ])
    ...
    dataset = multi_gpu.dataloader(dataset, cfg.SOLVER.NUM_GPUS, **loader_args)
